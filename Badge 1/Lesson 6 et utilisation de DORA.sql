...
-- Configuration Dora API Integration
...
-- Check schema public exist in garden_plants
use database UTIL_DB;
use schema PUBLIC;
use role ACCOUNTADMIN;
...
-- DW003
-- create schema GARDEN_PLANTS.PUBLIC;
...
-- For check all history : GO to Monitoring > Query History > Filters > GRADER
